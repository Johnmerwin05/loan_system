...
$activity = "Deleted the information of " . $ticket;


 $query = mysqli_query($conn, "INSERT INTO borrower_archive SELECT * FROM borrower WHERE ticket = '$ticket'");
 $query = mysqli_query($conn, "DELETE FROM borrower WHERE ticket = '$ticket'");
