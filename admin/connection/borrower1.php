...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO pending (filename, ticket, name, amount, gender, civil, birthday, age, anak, study, paninirahan, address, work, phone, mobile, negosyo, email, asawa, t_asawa, bday_asawa, mobile_asawa, paninirahan_asawa, lugar_asawaa, Valid, gamit1,gamit2,gamit3,s1,s2,s3,v1,v2,v3) VALUES ('$filename','$ticket','$name','$amount','$gender','$civil','$birthday','$age','$anak','$study','$paninirahan','$address','$work','$phone','$mobile','$negosyo', '$email' ,'$asawa','$t_asawa','$bday_asawa','$mobile_asawa','$paninirahan_asawa','$lugar_asawaa', '$Valid', '$gamit1', '$gamit2', '$gamit3', '$s1', '$s2', '$s3', '$v1', '$v2', '$v3')";
