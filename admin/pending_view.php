...
<a href="pending.php" class="hidden-print"><button type="button" class="btn btn-secondary" data-dismiss="modal">Back</button></a>
...
<section id="my-selection">
                ...
                $query="SELECT * from pending WHERE ticket = '$ticket'";  
                ...
                <br>
                        ...
                        <h6 id= "ttr" class="modal-title" style="margin-bottom: 2%; color: #292929; font-weight: bolder; "> V. KATIBAYAN AT PANGAKO SA PAGBAYAD NG UTANG:</h6>
