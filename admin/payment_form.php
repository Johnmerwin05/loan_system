...
color: #BCC6CC;
        ...
        .form-group1 {
            display: inline-block; width:18.5%;
        }
    ...
    <button class="rounded-circle border-0" id="sidebarToggle"></button>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form method="POST" action="connection/payment.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label> Ticket </label>
                            <input type="text" name="ticket"  class="form-control" value="<?=$data['ticket'];?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="released"  class="form-control" value="<?=$data['released'];?>" readonly>
                        </div>

                        <div class="form-group">
                            <label> Pay date </label>
                            <input type="text" name="date"  class="form-control" value="<?=$gga?> of months" readonly>
                        </div>

                        <div class="form-group">
                            <label> Plan </label>
                            <input type="text" name="plan"  class="form-control" value="<?=implode(' ', $output);?>" readonly>
                        </div>

                        <div class="form-group">
                            <label> Interest </label>
                            <input type="text" name="interest"  class="form-control" value="₱ <?= $data['Int_amount'];?>" readonly>
                        </div>

                        <div class="form-group">
                            <label> Penalty </label>
                            <input type="text" name="penalty"  class="form-control" value="₱ <?= $data['pe_amount'];?>" readonly>
                        </div>

                        <div class="form-group">
                            <label> Monthly </label>
                            <input type="text" name="monthly"  class="form-control" value="₱ <?= $data['Int_amount'] + $data['month_amount'];?>" readonly>
                        </div>

                        <div class="form-group">
                        <label> Payment status </label>
                        <select class="form-control" aria-label="Default select example" name="payments"> 
                        <option selected="true" disabled="disabled">Pumili ng status ng bayad</option>   
                        ...
                        <div class="form-group1">
                            <label> Amount want to pay </label>
                            <input type="text" name="amount_payment"  class="form-control">
                        </div>
                        +
                        <div class="form-group">
                        <label> Penalty </label>
                        <select class="form-control" aria-label="Default select example" name="pet">
                        <option selected="true" disabled="disabled">Pumili ng penalty</option>   
                        <option value="<?= $data['pe_amount'];?>">₱ <?= $data['pe_amount'];?></option>
